...
//   FiatContract public price;
  ...
  uint256 public rate = 143;
//   Duration of ICO in minutes.Set to 86 days
  uint256 durationInMinutes = 123840;
...
//modifiers    
  ...
  function Crowdsale(address _tokenToBeUsed) 
  public
  nonZeroAddress(_tokenToBeUsed) {
...
contract FinalizableCrowdsale is Crowdsale, Ownable {
  ...
  function FinalizableCrowdsale(address _tokenToBeUsed) 
  Crowdsale( _tokenToBeUsed ) public{
 ...
 */
contract FURTCrowdsale is FinalizableCrowdsale {
  using SafeMath for uint256;

  //tokens available for ICO 5000 000 000
  uint256 public tokensAvailableToIco = 5000000000000000000000000000;
  ...
  function FURTCrowdsale( address _wallet, address _tokenToBeUsed ) 
  FinalizableCrowdsale( _tokenToBeUsed) public nonZeroAddress(_wallet){
  ...
  */
  function powerUpContract()public onlyOwner{
    ...
    // Contract should have enough FURT credits
